...
int options(){
	...
	std::cout<<"[6] In Degree of any vertex"<<std::endl;
	std::cout<<"[7] Out Degree of any vertex"<<std::endl;
	std::cout<<"[8] BFS "<<std::endl;
	std::cout<<"[9] DFS"<<std::endl;
...
int main(int argc, char* argv[]){
	...
	DirectedGraph graph(vertices,rep);
	...
	while(true){
		...
		switch(options()){
			...
			case 6	:	std::cout<<"Enter the vertex : ";
						cin>>v1;
						std::cout<<graph.indegree(v1)<<endl;
						break;

			case 7	:	std::cout<<"Enter the vertex : ";
						cin>>v1;
						std::cout<<graph.outdegree(v1)<<endl;
						break;

			case 8	:	graph.bfs(&print_it);
						break;

			case 9	:	graph.dfs(&print_it);
						break;																																				
